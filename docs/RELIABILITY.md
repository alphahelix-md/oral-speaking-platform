...
Limits: active recording killed by the OS is not guaranteed recoverable; clearing browser data removes local drafts; server-side idempotency, budgets and durable training-upload jobs remain separate work. No fallback model is enabled.
