...
export const english: LanguageConfig = {
  ...
  topics: { daily: ['Everyday life', 'Food & drink', 'Travel', 'Work & study'], ielts: ['Part 1 · Familiar topics', 'Part 2 · Long turn', 'Part 3 · Discussion'], topic: ['Technology', 'Culture', 'Education'], 'free-talk': ['Open conversation'] },
