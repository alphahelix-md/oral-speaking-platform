...
export const japanese: LanguageConfig = {
  ...
  rubric: [{ key: 'grammar', label: 'Grammar', guide: 'Tense and word order in transcript' }, { key: 'vocabulary', label: 'Vocabulary', guide: 'Range and collocations' }, { key: 'naturalness', label: 'Naturalness', guide: 'Idiomatic phrasing and sentence endings' }, { key: 'appropriateness', label: 'Appropriateness', guide: 'Scenario fit' }, { key: 'particleUsage', label: 'Particle usage', guide: 'Accuracy of は、が、を、に and other particles' }, { key: 'conjugation', label: 'Conjugation', guide: 'Verb and adjective forms' }, { key: 'register', label: 'Register', guide: 'Politeness, keigo and consistency of style' }],
