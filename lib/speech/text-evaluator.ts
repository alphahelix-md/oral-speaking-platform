...
export interface TextEvaluator {
  evaluate(provider: TextProvider, language: LanguageId, mode: ModeId, turns: Turn[], uiLanguage: UiLanguage, timeoutMs?: number, signal?: AbortSignal): Promise<Evaluation>;
}
